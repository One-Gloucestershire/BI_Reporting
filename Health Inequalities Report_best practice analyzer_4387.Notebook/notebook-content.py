...
dataset = "Health Inequalities Report" # Enter the name or ID of the semantic model
workspace = "BI Reporting Live" # Enter the workspace name or ID in which the semantic model exists
